...
const About = () => {
  return (
    ...
    I'm a skilled software developer with experience in
        JavaScript , python and other programming languages, and expertise in frameworks like React, Node.js, and
        electron. I'm a quick learner and collaborate closely with clients to
        create efficient, scalable, and user-friendly solutions that solve
        real-world problems. Let's work together to bring your ideas to life!
    </motion.p>
    <div className='mt-20 gap-10 flex flex-wrap max-sm:justify-center'>
